		...
		Children: []Widget{
			...
			Composite{
				...
				Children: []Widget{
					...
					Label{
						AssignTo:   &a.transportLabel,
						Text:       "Мережа: -",
						TextColor:  colorSoft,
						Background: SolidColorBrush{Color: colorWindow},
					},
					Label{
						AssignTo:   &a.uptimeLabel,
						Text:       "Up: -",
						TextColor:  colorSoft,
						Background: SolidColorBrush{Color: colorWindow},
					},
					HSpacer{},
					Label{
						AssignTo:   &a.acceptedLabel,
						Text:       "Ack: 0",
						TextColor:  colorGoodText,
						Background: SolidColorBrush{Color: colorGoodBg},
					},
					Label{
						AssignTo:   &a.rejectedLabel,
						Text:       "Nack: 0",
						TextColor:  colorBadText,
						Background: SolidColorBrush{Color: colorBadBg},
					},
					Label{
						AssignTo:   &a.rateLabel,
						Text:       "0 msg/min",
						TextColor:  colorAccentText,
						Background: SolidColorBrush{Color: colorAccentBg},
					},
				},
			},
		},
